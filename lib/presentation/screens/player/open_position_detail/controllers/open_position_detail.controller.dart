...
class OpenPositionDetailController extends GetxController with AppLoadingMixin {
  ...
  void _deleteConfirmationDialog({String type = AppString.strOpenPosition}) {
  ...
  void _getPostDetailSuccess(dio.Response response) {
    ...
    postModel.value = GetIt.I<CommonUtils>()
        .getPostModelForOpenPosition(userDetailResponseModel.data!);
  }
