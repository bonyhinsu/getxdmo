...
class ResultDetailController extends GetxController with AppLoadingMixin {
  ...
  void onEditPost() {
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      // Navigate to add result detail screen.
  ...
  void _deleteConfirmationDialog({String type = AppString.strResult}) {
  ...
  void _getPostDetailSuccess(dio.Response response) {
    ...
    postModel.value = GetIt.I<CommonUtils>()
        .getPostModelForResult(userDetailResponseModel.data!);
  }
